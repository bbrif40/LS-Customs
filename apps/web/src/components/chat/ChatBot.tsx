        ...
        <div className="chat-window">
          <div className="chat-header">
            ...
            <div className="chat-header-actions">
              <button className="chat-action-btn" onClick={() => void sendMessage("I want to create a support ticket to talk to an admin")} title="Create support ticket" aria-label="Create ticket">
                <TicketPlus size={14} />
              </button>
